<template>
	<section id="contenu-accueil">
		<div class="background-wrapper">
			<div class="background savonnerie front"></div>
		</div>

		<nav>
			<div v-bind:class="{ hidden: isHidden }" class="prev quicknav">
				<svg
					fill="none"
					viewBox="0 0 24 24"
					height="24"
			...
			<div v-bind:class="{ hidden: isHidden }" class="next quicknav">
				<span></span>
				<svg
					fill="none"
					viewBox="0 0 24 24"
