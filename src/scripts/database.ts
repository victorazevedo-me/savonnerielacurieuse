export default {
    "contact":{
       "adresse":"Rue du Château 63120 Vollore-Ville",
    ...
    "faq":[
       {
          ...
          "reponse":"L'huile d'olive, de ricin, de jojoba, de coco, le beurre de karité, le beurre de cacao ainsi que toutes les huiles essentielles sont issus de l'agriculture biologique. L'huile de tournesol est produite sous mention Nature & Progrès à Moissat, à moins de 30km de la savonnerie par le GAEC Dou Chonlai. Les savons sont emballés dans des sachets de cellophane végétale compostable."
       },
       {
          "question":"J'ai les cheveux secs, le savon shampooing Thé Citron me convient-il ?",
          "reponse":"Le savon shampooing Thé Citron convient bien aux cheveux normaux et/ou mixtes. Si vos cheveux sont secs, préférez lui le savon Délice enrichi au beurre de cacao nourrissant. De plus, Délice est hypoallergénique et convient bien aux jeunes enfants."
       },
       {
          "question":"Curieuse, d'accord, mais cette savonnerie est elle sérieuse ?",
          "reponse":"La savonnerie La Curieuse est enregistrée en temps qu'établissement cosmétique auprès de l'ANSM (Agence Nationale de Sécurité des Médicaments et des produits de santé) et chaque formule de savons est validée par un expert cosmétique."
       },
       {
          "question":"Est-ce qu'il y a des ingrédients d'origine animale dans vos savons ?",
          "reponse":"Non. Les ingrédients utilisés dans la confection des savons La Curieuse sont d'origine végétale (huile d'olive, de coco, de tournesol, etc.) et minérale (argile ghassoul)."
       },
       {
